...
const YogaPoseLibrary = () => {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-gray-950 text-white' : 'bg-gray-100 text-gray-900'}`}>
      ...
      {/* Footer */}
      <footer className={`${darkMode ? 'bg-gray-900 text-gray-400 border-gray-800' : 'bg-white text-gray-600 border-gray-200'} py-6 mt-8 border-t`}>
        <div className="max-w-6xl mx-auto px-4 flex flex-col items-center">
          <p className="text-sm mb-2">© 2025 Yoga Asana Library - All rights reserved</p>
          <div className="flex space-x-4 mb-4">
            <button className={`rounded-full p-2 ${darkMode ? 'hover:bg-gray-800' : 'hover:bg-gray-100'}`} aria-label="Share">
              <Share2 size={18} />
            </button>
            <button className={`rounded-full p-2 ${darkMode ? 'hover:bg-gray-800' : 'hover:bg-gray-100'}`} aria-label="Help">
              <Info size={18} />
            </button>
            <button 
              onClick={() => setDarkMode(!darkMode)}
              className={`rounded-full p-2 ${darkMode ? 'hover:bg-gray-800' : 'hover:bg-gray-100'}`} 
          ...
          <div className="text-xs">
            Always consult with a qualified yoga instructor before attempting new poses.
          </div>
        </div>
      </footer>
